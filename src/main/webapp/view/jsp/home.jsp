...
<head>
    ...
    <title><fmt:message key="home.name" bundle="${lang}"/></title>
...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li>
                <a href="${abs}/controller?command=go_language_page&main_page=view/jsp/home.jsp"
                   class="nav-link px-2 link-secondary"><fmt:message key="language" bundle="${lang}"/></a></li>
        </ul>
        <form action="${abs}/controller">
            <button name="command" value="go_sign_in_page" class="btn btn-outline-primary">
                <fmt:message key="home.login" bundle="${lang}"/>
            </button>
            <button name="command" value="go_registration_page" class="btn btn-primary">
                <fmt:message key="home.sign-up" bundle="${lang}"/>
            </button>
        </form>
    </header>
</div>
