...
<main>
  <form action="${abs}/controller">
    <h1 class="h3 mb-3 fw-normal">Введите сумму</h1>
    <br/>
    <input type="number" name="price" checked min="1">
    <br/>
    <div>
      <button class="btn btn-primary" name="command" value="refill">Пополнить</button>
    </div>
