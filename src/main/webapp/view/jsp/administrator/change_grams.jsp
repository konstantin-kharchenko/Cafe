...
<head>
    ...
    <title><fmt:message key="change.grams" bundle="${lang}"/></title>
...
<div class="body">
    <main class="form-signin text-center">
        <form action="${abs}/controller" method="post">
            ...
            <input type="hidden" name="id_ingredient" value="${ingredient.idIngredient}"/>
            <input type="hidden" name="id_product" value="${id_product}"/>
            <img class="mb-4" src="${abs}/view/img/pngtree-vector-coffee-icon-png-image_449722.jpg" alt="" width="72"
                 height="57">
            <h1 class="h3 mb-3 fw-normal"><fmt:message key="enter.grams" bundle="${lang}"/></h1>

            <div class="form-floating">
                <input type="text" class="form-control" id="shelf_life" name="grams" min="1"
                       value="${ingredient.grams}" required>
                <label for="shelf_life"><fmt:message key="grams" bundle="${lang}"/></label>
            </div>
            <label id="labelDate"></label>
            <button class="w-100 btn btn-lg btn-primary" name="command" value="change_grams">
