...
<head>
    ...
    <title><fmt:message key="basket.ingredients" bundle="${lang}"/></title>
...
<main>
    ...
    <div class="container row row-cols-4">
        <c:forEach items="${basket_ingredients}" var="ingredient">
            <div class="col pb-3">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a href="${abs}/controller?command=delete_ingredient_from_basket&id_ingredient=${ingredient.idIngredient}"
