...
<head>
    ...
    <title><fmt:message key="client.profile" bundle="${lang}"/></title>
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right"><fmt:message key="profile.settings" bundle="${lang}"/></h4>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12"><label class="labels"><fmt:message key="experience"
                                                                                  bundle="${lang}"/></label><input
                                type="text"
                                class="form-control"
                                name="experience"
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <button class="w-100 btn btn-lg btn-primary" name="command" value="update_administrator">
                            <fmt:message key="profile.save" bundle="${lang}"/>
                        </button>
                    </div>
