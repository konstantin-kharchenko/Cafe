    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li>
                    <a href="${abs}/controller?command=go_language_page&main_page=view/jsp/administrator/administrator.jsp"
                       class="nav-link px-2 link-dark"><fmt:message key="language" bundle="${lang}"/></a>
                </li>
                <li>
                    <a href="${abs}/controller?command=client&currentPage=1"
                       class="nav-link px-2 link-dark"><fmt:message key="all.clients" bundle="${lang}"/></a>
                </li>
                <li>
                    <a href="${abs}/controller?command=go_all_products&currentPage=1"
                       class="nav-link px-2 link-dark"><fmt:message key="client.menu" bundle="${lang}"/></a>
                </li>
                <li>
                    <a href="${abs}/controller?command=go_all_ingredients&currentPage=1"
                       class="nav-link px-2 link-dark"><fmt:message key="admin.ingredients" bundle="${lang}"/></a>
                </li>
                <li>
                    <a href="${abs}/controller?command=administrator_applications"
                       class="nav-link px-2 link-dark"><fmt:message key="admin.applications" bundle="${lang}"/></a>
                </li>
                <li>
                    <a href="${abs}/controller?command=go_administrator_basket_page"
                       class="nav-link px-2 link-dark"><fmt:message key="basket.ingredients" bundle="${lang}"/>
                        <c:choose>
                            <c:when test="${basket_ingredients.size() > 0}">
                                +${basket_ingredients.size()}
                            </c:when>
                        </c:choose>
                    </a>
                </li>
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <a href="${abs}/controller?command=go_add_product_page"
                   class="btn btn-primary"><fmt:message key="create.product" bundle="${lang}"/></a>
            </ul>
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <a href="${abs}/controller?command=go_add_ingredient_page"
                   class="btn btn-primary"><fmt:message key="create.ingredient" bundle="${lang}"/></a>
            </ul>
            <div class="dropdown text-end">
                ...
                <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                    <li><a class="dropdown-item"
                           href="${abs}/controller?command=go_administrator_profile_page"><fmt:message
...
<div class="main">
    <div style="margin-left: 1.5%; margin-right: 1.5%">
        <div class="row row-cols-2">
                        ...
                        <aside>
                            <div class="list-group">
                                <c:forEach var="client" items="${clients}">
                                    <a href="${abs}/controller?command=overdue_client_orders&id_client=${client.idClient}"
            ...
            <div>
                <h1 class="h3 mb-3 fw-normal"><fmt:message key="today.orders" bundle="${lang}"/></h1>
                <div class="container text-center">
                    <aside>
                        <div class="list-group">
