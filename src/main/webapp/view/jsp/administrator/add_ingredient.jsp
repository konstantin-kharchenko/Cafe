...
<head>
    ...
    <title><fmt:message key="create.ingredient" bundle="${lang}"/></title>
    ...
    <main class="form-signin text-center">
        <form action="${abs}/controller">
            ...
            <img class="mb-4" src="${abs}/view/img/pngtree-vector-coffee-icon-png-image_449722.jpg" alt="" width="72"
                 height="57">
            <h1 class="h3 mb-3 fw-normal"><fmt:message key="create.ingredient" bundle="${lang}"/></h1>
            ...
            <button class="w-100 btn btn-lg btn-primary" name="command" value="add_ingredient">
